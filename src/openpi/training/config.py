...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi05_embodichain_carry_basket_H10",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
    ...
    TrainConfig(
        name="pi05_embodichain_dock_tubes_H10",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
    ...
    TrainConfig(
        name="pi05_embodichain_insert_test_tube_H10",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
    ...
    TrainConfig(
        name="pi05_embodichain_open_pan_H10",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
    ...
    TrainConfig(
        name="pi05_embodichain_rearr_H10",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
    ...
    # pi0 EmbodiChain tasks.
    TrainConfig(
        name="pi0_embodichain_beaker_mixer_H10",
        model=pi0_config.Pi0Config(action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_beaker_mixer",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi0_embodichain_carry_basket_H10",
        model=pi0_config.Pi0Config(action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_carry_basket",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi0_embodichain_click_bell_H10",
        model=pi0_config.Pi0Config(action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_click_bell",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi0_embodichain_depress_pipette_H10",
        model=pi0_config.Pi0Config(action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_depress_pipette",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi0_embodichain_dock_tubes_H10",
        model=pi0_config.Pi0Config(action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_dock_tubes",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi0_embodichain_insert_test_tube_H10",
        model=pi0_config.Pi0Config(action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_insert_test_tube",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi0_embodichain_items_hand_over_place_H10",
        model=pi0_config.Pi0Config(action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_items_handover_place",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi0_embodichain_open_drawer_H10",
        model=pi0_config.Pi0Config(action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_open_drawer",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi0_embodichain_open_pan_H10",
        model=pi0_config.Pi0Config(action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_open_pan",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi0_embodichain_pour_dual_H10",
        model=pi0_config.Pi0Config(action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_pour_water_dual",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi0_embodichain_rearr_H10",
        model=pi0_config.Pi0Config(action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_rearr",
            base_config=DataConfig(prompt_from_task=True),
    ...
    # ========== SPECIAL =========== #
    TrainConfig(
        name="pi0_embodichain_depress_pipette_H30",
    ...
    TrainConfig(
        name="pi0_embodichain_items_hand_over_place_H30",
        model=pi0_config.Pi0Config(action_horizon=30),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_items_handover_place",
            base_config=DataConfig(prompt_from_task=True),
