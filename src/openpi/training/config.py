...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        model=pi0_config.Pi0Config(),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_insert_test_tube",
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
        ),
        batch_size=1024,
    ...
    TrainConfig(
        ...
        model=pi0_config.Pi0Config(),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_carry_basket",
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
        ),
        batch_size=1024,
    ...
    TrainConfig(
        name="pi0_embodichain_Sim_click_bell_align",
        model=pi0_config.Pi0Config(),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_click_bell_align_0507",
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
        ),
        checkpoint_base_dir="/aoss/openpi_sim_ckpts",
    ...
    TrainConfig(
        name="pi0_embodichain_Sim_click_bell_align_H10",
        model=pi0_config.Pi0Config(action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_click_bell_align_0507",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi0_embodichain_Sim_click_bell_align_abs",
        model=pi0_config.Pi0Config(),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_click_bell_align_0507",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi0_embodichain_Sim_click_bell_align_abs_realaftersim10000_noopt",
        model=pi0_config.Pi0Config(),
        data=LeRobotSLAIPiperDataConfig(
            repo_id="ZhaoRunyi/Piper_click_bell_0403",
            state_space=slai_piper_policy.StateSpaceConfig(
                ids="joint_gripper",
                gripper=slai_piper_policy.GripperConfig(type="01"),
            ),
            action_space=slai_piper_policy.ActionSpaceConfig(
                ids="joint_gripper",
                gripper=slai_piper_policy.GripperConfig(type="01"),
        ...
        checkpoint_base_dir="/aoss/openpi_sim_ckpts",
        pytorch_weight_path="/aoss/openpi_sim_ckpts/pi0_embodichain_Sim_click_bell_align_abs/pi0_embodichain_Sim_click_bell_align_abs_bs32/10000",
        batch_size=32,
    ...
    TrainConfig(
        name="pi0_embodichain_Sim_click_bell_aligns_simreal5050",
        model=pi0_config.Pi0Config(),
        datasets=(
            LeRobotEmbodiChainDataConfig(
                repo_id="embodichain_sim_data/cobotmagic_Sim_click_bell_align_0507",
                base_config=DataConfig(prompt_from_task=True),
                extra_delta_transform=False,
            ),
    ...
    TrainConfig(
        name="pi0_embodichain_Sim_click_bell_up_H10",
        model=pi0_config.Pi0Config(action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_click_bell_up_0508",
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
        ),
        checkpoint_base_dir="/aoss/openpi_sim_ckpts",
    ...
    TrainConfig(
        name="pi0_embodichain_Sim_click_bell_up_H16",
    ...
    TrainConfig(
        name="pi0_embodichain_Sim_click_bell_up_H10_abs",
        model=pi0_config.Pi0Config(action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_click_bell_up_0508",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi0_embodichain_Sim_click_bell_up_H16_abs",
        model=pi0_config.Pi0Config(action_horizon=16),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_click_bell_up_0508",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi05_embodichain_click_bell_H30",
    ...
    TrainConfig(
        name="pi05_embodichain_click_bell_H30_abs",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=30),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_click_bell",
            base_config=DataConfig(prompt_from_task=True),
    ...
    # == 0505 == #
    TrainConfig(
        name="pi05_embodichain_click_bell_0505",
        model=pi0_config.Pi0Config(pi05=True),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_click_bell_0505",
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        name="pi05_embodichain_click_bell_0505_simreal5050",
        model=pi0_config.Pi0Config(
            pi05=True,
    ...
    # ================ PI05 ================ #
    TrainConfig(
        name="pi05_embodichain_click_bell",
        model=pi0_config.Pi0Config(pi05=True),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_click_bell",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi05_embodichain_beaker_mixer",
        model=pi0_config.Pi0Config(pi05=True),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_beaker_mixer",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi05_embodichain_items_handover_place",
        model=pi0_config.Pi0Config(pi05=True),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_items_handover_place",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi05_embodichain_depress_pipette",
        model=pi0_config.Pi0Config(pi05=True),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_depress_pipette",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi05_embodichain_open_pan",
        model=pi0_config.Pi0Config(pi05=True),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_open_pan",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi05_embodichain_pour_dual",
        model=pi0_config.Pi0Config(pi05=True),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_pour_dual",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi05_embodichain_insert_test_tube",
        model=pi0_config.Pi0Config(pi05=True),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_insert_test_tube",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi05_embodichain_dock_tubes",
        model=pi0_config.Pi0Config(pi05=True),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_dock_tubes",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi05_embodichain_open_drawer",
        model=pi0_config.Pi0Config(pi05=True),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_open_drawer",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi05_embodichain_carry_basket",
        model=pi0_config.Pi0Config(pi05=True),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="embodichain_sim_data/cobotmagic_Sim_carry_basket",
            base_config=DataConfig(prompt_from_task=True),
