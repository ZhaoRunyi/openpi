...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        data=LeRobotEmbodiChainDataConfig(
            ...
            repo_id="cobotmagic_Sim_press_the_button_000",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        ...
        data=LeRobotEmbodiChainDataConfig(
            ...
            # Example local dataset folder generated by EmbodiChain:
            #   cobotmagic_Sim_manipulate_mixer_duel_000
            repo_id="cobotmagic_Sim_rearrange_the_table_by_placing_the_spoon_and_fork_on_either_side_of_the_plate_008",
            base_config=DataConfig(prompt_from_task=True),
            # EmbodiChain datasets are usually absolute-action targets.
            # Keep this False unless your checkpoint expects extra delta conversion.
            extra_delta_transform=True,
    ...
    TrainConfig(
        name="pi05_embodichain_manipulate_pipette",
        model=pi0_config.Pi0Config(pi05=True),
        data=LeRobotEmbodiChainDataConfig(
    ...
    TrainConfig(
        name="pi05_embodichain_sample_loading_duel",
        model=pi0_config.Pi0Config(pi05=True),
        data=LeRobotEmbodiChainDataConfig(
